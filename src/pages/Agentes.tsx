...
import { Ear, Eye, Heart, Volume2, Target, Zap, Users } from "lucide-react";
...
const Agentes = () => {
  ...
  const handleTestAgent = (agent) => {
    // Navega para a página inicial informando o agente via query string
    const q = encodeURIComponent(agent.name)
    navigate(`/?agent=${q}`)
  };
      ...
      <div className="min-h-screen bg-gradient-gentle">
        ...
        <main className="container mx-auto px-4 py-8" role="main">
          ...
          <section className="text-center mb-12 animate-fade-in">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-sm px-4 sm:px-0">
              <div className="flex items-center gap-2 bg-card p-3 rounded-lg shadow-card w-full sm:w-auto">
