    ...
    <ThemeProvider attribute="class" defaultTheme="light" enableSystem>
      <div className="min-h-screen bg-gradient-gentle">
        ...
        <main className="container mx-auto px-4 py-8" role="main">
          ...
          <section className="mb-16 animate-soft-slide-up">
            <h2 className="text-3xl font-bold text-foreground text-center mb-8">
              Agentes Especializados
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              <Card className="text-center shadow-card anim-breathe">
          ...
          <section className="text-center bg-card rounded-2xl p-8 shadow-card">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 mb-6 px-2">
              <Button variant="outline" size="sm" className="gap-2 w-full sm:w-auto whitespace-normal break-words text-left h-auto min-w-0">
