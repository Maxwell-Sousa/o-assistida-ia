...
import { Home, Users, Info, LogOut, Menu, Sun, Moon, Settings } from "lucide-react";
    ...
    <header className="bg-background/80 backdrop-blur-md border-b border-border shadow-card sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            <img src="/Logo.png" alt="Logo Agentes da Inclusão" className="h-12 w-12 object-contain anim-float" />
            <div>
